  ...
  return (
    <div className="mt-4 flex flex-col">
      ...
      <div className="flex gap-[12px] flex-col">
        ...
        <section
          className="text-[clamp(16px,1.4vw,20px)] w-[clamp(180px,23vw,360px)] py-[12px] rounded-[10px] flex justify-center text-[#333]"
          style={{
            borderRadius: "10px",
      ...
      <div
        className="h-full w-full mt-[12px] !rounded-[10px] flex gap-1"
